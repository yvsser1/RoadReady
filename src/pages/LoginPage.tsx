...
export default function LoginPage() {
  ...
  return (
    <div className="container relative flex min-h-screen items-center justify-center p-4 bg-rose-50 dark:bg-black">
      <div className="flex w-full flex-col gap-6 max-w-[800px]">
              ...
              <div className="flex flex-col gap-6">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-balance text-muted-foreground">
                    Login to your RoadReady account
                  </p>
                </div>
